    ...
    return (
      <div className="flex flex-col items-center justify-center p-8 bg-red-50 border border-red-200 rounded-lg text-center max-w-2xl mx-auto my-8">
        ...
        <p className="text-red-700 mb-4">
          Não foi possível carregar {resourceName} porque as tabelas não existem no Supabase.
        </p>
        <div className="bg-white p-4 rounded border border-red-100 text-left w-full shadow-sm">
